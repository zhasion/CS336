...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    multi_head_self_attention = MultiHeadSelfAttention(d_model=d_model, 
                                                       num_heads=num_heads, 
                                                       use_rope=True, 
                                                       theta=theta, 
...
def run_rmsnorm(
    ...
    """
    rms_norm = RMSNorm(d_model=d_model, eps=eps, device=in_features.device, dtype=in_features.dtype)
