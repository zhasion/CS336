...
from cs336_alignment.data_loading import PackedSFTDataset, get_iterate_batches
from cs336_alignment.eval_mmlu_baseline import parse_mmlu_response
from cs336_alignment.eval_gsm8k_baseline import parse_gsm8k_response
...
def run_iterate_batches(
    ...
    """
    return get_iterate_batches(dataset=dataset, batch_size=batch_size, shuffle=shuffle)
